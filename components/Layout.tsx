...
const allNavigation: NavItem[] = [
  ...
  { name: 'Chronic Team Monitoring',href: '/chronic-monitoring',  icon: LineChartIcon,   roles: ['admin', 'qc', 'action_officer'] },
  { name: 'Point Requests',         href: '/feeder-point-requests', icon: MapPin,        roles: ['admin', 'qc'] },
